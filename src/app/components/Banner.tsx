...
function Banner() {
  ...
  return (
    <div className={`relative h-[70vh] overflow-hidden`}>
      <div className="absolute inset-0 z-0 opacity-30 bg-[#FEF3E2]">
        <Carousel
          showThumbs={false}
          showStatus={false}
          infiniteLoop={true}
           ...
           <div key={index} className="h-full">
            <div style={{ height: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img
               src={image.src}
               alt={image.alt}
               className="w-full max-h-full object-contain blur" // Contain image within the bounds
